...
struct HilbertSort {
    ...
    int Split(SPoint3** vertices, int arraysize, int GrayCode0, int GrayCode1,
    ...
    void Sort(SPoint3** vertices, int arraysize, int e, int d,
        double BoundingBoxXmin, double BoundingBoxXmax,
        double BoundingBoxYmin, double BoundingBoxYmax,
    ...
    void MultiscaleSortHilbert(SPoint3** vertices, int arraysize, int threshold,
    ...
    void Apply(std::vector<SPoint3*>& v)
    {
...
inline void HilbertSort::ComputeGrayCode(int n)
{
...
inline int HilbertSort::Split(SPoint3** vertices, int arraysize, int GrayCode0,
    ...
    double BoundingBoxZmax)
{
    ...
    if (d > 0) {
        do {
            for (; i < arraysize; i++) {
                if (vertices[i]->at(axis) >= split) break;
            }
            for (; j >= 0; j--) {
                if (vertices[j]->at(axis) < split) break;
            }
...
inline void HilbertSort::Sort(SPoint3** vertices, int arraysize, int e, int d,
    double BoundingBoxXmin, double BoundingBoxXmax,
    double BoundingBoxYmin, double BoundingBoxYmax,
    double BoundingBoxZmin, double BoundingBoxZmax,
    int depth)
