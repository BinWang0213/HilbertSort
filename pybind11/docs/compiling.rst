...
PyPI integration, can be found in the [pyHilbertSort]_  repository.

.. [pyHilbertSort] https://github.com/pybind/pyHilbertSort
...
can refer to the same [pyHilbertSort]_ repository for a full sample project
